...
function updateCountdown() {
    ...
    // Crear un objeto de fecha actual en la zona horaria de Bolivia
    const now = new Date(new Date().toLocaleString("en-US", { timeZone: "America/La_Paz" }));

    // Fecha de Navidad en la zona horaria de Bolivia
    const christmas = new Date(now.getFullYear(), 11, 25); // Mes 11 es diciembre
    ...
    endMessage.textContent = `Faltan ${days} días, ${hours} horas, ${minutes} minutos y ${seconds} segundos para Navidad.`;
}
